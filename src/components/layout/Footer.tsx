...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Providing comprehensive accounting and financial services to small businesses and individuals for over 15 years. Trust our certified professionals to handle your books, taxes, and financial planning needs.',
  contactEmail: 'info@acmeaccounting.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Financial Plaza, Suite 200, Business District',
  newsletterTitle: 'Tax & Finance Updates',
  ...
  const footerSections = [
      ...
      links: [
        {
          ...
          editableId: 'link-footer-tax-preparation',
        },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Our Team', href: '/team', editableId: 'link-footer-team' },
        {
          name: 'Certifications',
          href: '/certifications',
          editableId: 'link-footer-certifications',
        },
        { name: 'Client Reviews', href: '/reviews', editableId: 'link-footer-reviews' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Calculators', href: '/calculators', editableId: 'link-footer-calculators' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Data Security', href: '/security', editableId: 'link-footer-security' },
        {
          ...
          editableId: 'link-footer-client-agreement',
        },
