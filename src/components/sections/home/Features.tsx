...
const DEFAULT_FEATURES = {
  ...
  mainDescription:
    'Streamline your accounting with automated bookkeeping, invoicing, and financial reporting designed specifically for small businesses and entrepreneurs.',
  ...
  feature2Description:
    '256-bit SSL encryption and SOC 2 compliance keeps your financial data secure and protected.',
  ...
  feature4Description:
    'Manage multiple businesses or entities from one dashboard with separate books and reporting.',
  feature4Badge: 'Multi-Business',
  feature5Title: 'Real-Time Financial Reports',
  feature5Description:
    'Get instant P&L statements, cash flow reports, and tax summaries updated in real-time.',
  feature5Badge: 'Reporting',
  feature6Title: 'Smart Invoice Templates',
  feature6Description:
    'Create professional invoices with automated payment reminders and online payment processing.',
  feature6Badge: 'Invoicing',
  feature7Title: 'Tax Preparation Ready',
  feature7Description:
    'Export tax-ready reports and integrate with TurboTax, H&R Block, and major tax software.',
  feature7Badge: 'Tax Prep',
  feature8Title: 'Expert CPA Support',
  feature8Description:
    'Get help from certified accountants via chat, email, or phone with unlimited support included.',
  feature8Badge: 'Support',
  feature9Title: 'Data Backup & Privacy',
  feature9Description:
    'Daily automated backups and GDPR compliance ensure your financial data is safe and private.',
