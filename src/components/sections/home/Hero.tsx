...
const DEFAULT_HERO = {
  ...
  description:
    'Automate invoicing, track expenses, and get real-time financial insights. Built specifically for small businesses and entrepreneurs who want to focus on growth, not paperwork.',
  features: [
  ...
  imageAlt: 'Acme Accounting dashboard showing financial overview',
