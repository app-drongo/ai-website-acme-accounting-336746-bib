...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small business owners who trust Acme Accounting to handle their finances. Get personalized support and start your free trial today.',
  ...
  method2Description: 'Speak with our accounting specialists',
  ...
  office2City: 'Austin',
  office2Address: '456 Business Park Drive, Floor 8',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'San Francisco',
  office3Address: '789 Startup Boulevard, Building C',
  ...
  messagePlaceholder:
    'What type of business do you run? How many transactions per month? Any specific accounting challenges we can help with?',
} as const;
